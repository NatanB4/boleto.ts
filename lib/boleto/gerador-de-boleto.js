...
const timesNewRoman = path.join(diretorioDeFontes, 'Roboto-Regular.ttf');
const timesNewRomanNegrito = path.join(diretorioDeFontes, 'Roboto-Bold.ttf');
const timesNewRomanItalico = path.join(diretorioDeFontes, 'Roboto-Italic.ttf');
const timesNewRomanNegritoItalico = path.join(diretorioDeFontes, 'Roboto-Bold Italic.ttf');
...
var GeradorDeBoleto = (function () {
    ...
    const pdfDefaults = {
        ...
        informacoesPersonalizadas: function (pdf, x, y, sac) {

            pdf.font('negrito')
                .fontSize(8)
                .text('Sacador/Avalista 1', sac.x + 11, sac.y - 26, {
                    lineBreak: false,
                    width: 294,
                    align: 'left'
                });
    ...
    GeradorDeBoleto.prototype.gerarPDF = function (args) {
        return new Promise((resolve, reject) => {
            try {
                ...
                const informacoesPersonalizadas = args.informacoesPersonalizadas ? args.informacoesPersonalizadas : pdfDefaults.informacoesPersonalizadas;
                ...
                boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
                    ...
                    pdf.font('normal')
                        .fontSize(pagador.getIdentificacao().length >= 45 ? 7 : args.tamanhoDaFonte) // TODO: Diminuir tamanho da fonte caso seja maior que X caracteres
                    ...
                    try {
                        ...
                        linhaDigitavelSetavel = linhaDigitavel;
                    } catch (error) {
                    ...
                    pdf.font('codigoDeBarras')
                        ...
                        .text(i25(codigoDeBarras), args.ajusteX + margemDoSegundoBlocoLayout - 7.4, args.ajusteY + linha212 + 10.5, {
                            lineBreak: false,
                            width: 340,
                            align: 'left'
                        });
                    ...
                    boleto.getLocaisDePagamento().forEach(function (localDePagamento, indice) {
                        ...
                        pdf.font('normal')
                            .fontSize(args.tamanhoDaFonteDoTitulo + 1.2)
                    ...
                    pdf.font('negrito')
                        .fontSize(args.tamanhoDaFonteDoTitulo)
                        .text('Código de Baixa', args.ajusteX + 360, args.ajusteY + tituloDaSetimaLinha + 148, {
                            lineBreak: false,
                            width: 294,
                            align: 'left'
                        });
                    ...
                    pdf.font('negrito')
                        .fontSize(args.tamanhoDaFonteDoTitulo + 1)
                        .text('Autenticação mecânica - Ficha de Compensação', args.ajusteX + 360, args.ajusteY + linha212 + 15, {
                            lineBreak: false,
                            width: 294,
                            align: 'left'
                        });
                    ...
                    informacoesPersonalizadas(pdf, args.ajusteX + margemDoSegundoBlocoLayout, args.ajusteY + linha212 + args.tamanhoDoCodigoDeBarras, { x: args.ajusteX + margemDoSegundoBlocoLayout - 7.4, y: args.ajusteY + linha212 });
                ...
                if (args.base64) {
                    ...
                    stream.on('end', function () {
                        resolve({ base64: finalString, linhaDigitavel: linhaDigitavelSetavel });
