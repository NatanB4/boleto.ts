    ...
    GeradorDeBoleto.prototype.gerarPDF = function (args) {
        return new Promise((resolve) => {
            ...
            boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
                ...
                console.log( boleto.getLocaisDePagamento());
                pdf.font('negrito')
                    .fontSize(args.tamanhoDaFonteDoTitulo)
                ...
                pdf.font('negrito')
                    ...
                    console.log(pagador.getIdentificacao());
                pdf.font('normal')
                    .fontSize(args.tamanhoDaFonte)
                ...
                pdf.font('negrito')
                    .fontSize(args.tamanhoDaFonteDoTitulo)
                    .text('Código de Baixa', args.ajusteX + 360, args.ajusteY + tituloDaSetimaLinha + 159, {
                        lineBreak: false,
                        width: 294,
                        align: 'left'
                    });
                ...
                pdf.font('negrito')
                    .fontSize(args.tamanhoDaFonteDoTitulo + 1)
                    .text('Autenticação mecânica - Ficha de Compensação', args.ajusteX + 360, args.ajusteY + tituloDaSetimaLinha + 178.5, {
                        lineBreak: false,
                        width: 294,
                        align: 'left'
                    });
