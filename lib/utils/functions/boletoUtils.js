...
var Boleto = (function () {
  ...
  Boleto.prototype.getFatorVencimento = function () {
    ...
    const DATA_BASE_2022 = new Date(2022, 5, 29);
    var vencimento = this.getDatas().getVencimento()

    let diferencaEmDias = (vencimento - DATA_BASE_1997) / (1000 * 60 * 60 * 24);

    if (diferencaEmDias > 9999) {
      diferencaEmDias = (vencimento - DATA_BASE_2022) / (1000 * 60 * 60 * 24);
    }
