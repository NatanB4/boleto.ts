...
var Datas = (function () {
  ...
  Datas.prototype.comDocumento = function (_documento, locate = 'usa') {
    _documento = new Date(moment(new Date(_documento)).add(86400000).format('YYYY-MM-DD'));
  ...
  Datas.prototype.comProcessamento = function (_processamento, locate = 'usa') {
    _processamento = new Date(moment(new Date(_processamento)).add(86400000).format('YYYY-MM-DD'));
  ...
  Datas.prototype.comVencimento = function (_vencimento, locate = 'usa') {
    _vencimento = new Date(moment(new Date(_vencimento)).add(86400000).format('YYYY-MM-DD'));
...
var Boleto = (function () {
  ...
  Boleto.prototype.getFatorVencimento = function () {
    const DATA_BASE_1997 = new Date(1997, 9, 7);
    const DATA_BASE_2025 = new Date(2025, 0, 1); // 01/01/2025
    var vencimento = this.getDatas().getVencimento()

    let diferencaEmDias;

    if (vencimento >= DATA_BASE_2025) {
      diferencaEmDias = (vencimento - DATA_BASE_2025) / (1000 * 60 * 60 * 24);
    } else {
      diferencaEmDias = (vencimento - DATA_BASE_1997) / (1000 * 60 * 60 * 24);
    }
