...
var Datas = (function () {
    ...
    Datas.prototype.comDocumento = function (_documento, locate = 'usa') {
        _documento = new Date(moment(new Date(_documento)).add(86400000 * 2).format('YYYY-MM-DD')); 
    ...
    Datas.prototype.comProcessamento = function (_processamento, locate = 'usa') {
        _processamento = new Date(moment(new Date(_processamento)).add(86400000 * 2).format('YYYY-MM-DD'));
    ...
    Datas.prototype.comVencimento = function (_vencimento, locate = 'usa') {
        _vencimento = new Date(moment(new Date(_vencimento)).add(86400000 * 2).format('YYYY-MM-DD'));
